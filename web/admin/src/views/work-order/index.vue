  ...
  <section class="work-order-page" v-loading="loading">
    <template v-if="isDetail">
      <div class="page-head">
        ...
        <div class="actions">
          <el-button type="primary" @click="action('workOrderAction', detail || {})">工单流转</el-button>
        ...
        <el-table :data="rows" stripe empty-text="暂无工单" @selection-change="selectionRows=$event">
          ...
          <el-table-column label="操作" fixed="right" width="160">
            <template #default="scope">
              ...
              <el-button link type="primary" @click="action('workOrderAction', scope.row)">流转</el-button>
            </template>
          </el-table-column>
        </el-table>
