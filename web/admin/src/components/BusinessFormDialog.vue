...
const toPayload = () => {
  ...
  if (props.type === 'cancel' || props.type === 'release') return { reason: form.reason }
  return {}
}
const submit = async () => {
...
<style scoped>
.business-form :deep(.el-select),.business-form :deep(.el-date-editor){width:100%}.operation-confirm{margin:12px 0;color:#c6d4e1}
</style>
