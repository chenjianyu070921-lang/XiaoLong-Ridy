...
>
> 文档定位：本文件是运营后台完整目标态设计蓝图，包含未开放页面、未来服务拆分和 MQ/job 规划；当前已实现接口以 `docs/api/管理后台接口文档.md`、`docs/admin/管理后台HTTP到RPC边界说明.md`、`docs/admin/管理后台全模块RPC依赖调用清单.md` 为准。
>
...
sequenceDiagram
  ...
  OrderRPC->>DB: 由 ordersvc 查询 ride_order/order_status_log（adminsvc 不直接访问该库）
