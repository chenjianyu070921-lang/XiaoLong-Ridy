...
const (
	...
	User_AdminListUserCoupons_FullMethodName = "/usersvc.User/AdminListUserCoupons"
...
type UserClient interface {
	...
	AdminListUserCoupons(ctx context.Context, in *AdminListUserCouponsRequest, opts ...grpc.CallOption) (*AdminListUserCouponsResponse, error)
...
func (c *userClient) AdminListUserCoupons(ctx context.Context, in *AdminListUserCouponsRequest, opts ...grpc.CallOption) (*AdminListUserCouponsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AdminListUserCouponsResponse)
	err := c.cc.Invoke(ctx, User_AdminListUserCoupons_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) AdminFreezeUser(ctx context.Context, in *AdminFreezeUserRequest, opts ...grpc.CallOption) (*AdminFreezeUserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AdminFreezeUserResponse)
	err := c.cc.Invoke(ctx, User_AdminFreezeUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServer interface {
	...
	// AdminListUserCoupons 为管理后台提供用户券查询能力。
	AdminListUserCoupons(context.Context, *AdminListUserCouponsRequest) (*AdminListUserCouponsResponse, error)
	// LockUserCoupon 下单前锁定用户券，防止重复使用。
...
func (UnimplementedUserServer) AdminListUserCoupons(context.Context, *AdminListUserCouponsRequest) (*AdminListUserCouponsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AdminListUserCoupons not implemented")
}
func (UnimplementedUserServer) LockUserCoupon(context.Context, *LockUserCouponRequest) (*LockUserCouponResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LockUserCoupon not implemented")
}
...
func _User_AdminListUserCoupons_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AdminListUserCouponsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).AdminListUserCoupons(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_AdminListUserCoupons_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).AdminListUserCoupons(ctx, req.(*AdminListUserCouponsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _User_AdminFreezeUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AdminFreezeUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).AdminFreezeUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_AdminFreezeUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).AdminFreezeUser(ctx, req.(*AdminFreezeUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var User_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AdminListUserCoupons",
			Handler:    _User_AdminListUserCoupons_Handler,
		},
		{
