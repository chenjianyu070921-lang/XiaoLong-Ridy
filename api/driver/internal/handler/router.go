...
func NewRouter(svcCtx *svc.ServiceContext) http.Handler {
	...
	mux.Handle("/api/driver/v1/home-destination", protected(methodSwitch("GET", GetHomeDestinationHandler(svcCtx))))
	mux.Handle("/api/driver/v1/home-destination/save", protected(methodSwitch("POST", SetHomeDestinationHandler(svcCtx))))
	mux.Handle("/api/driver/v1/home-destination/mode", protected(methodSwitch("POST", SetHomeModeHandler(svcCtx))))
