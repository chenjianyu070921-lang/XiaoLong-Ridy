CREATE TABLE IF NOT EXISTS `driver_review` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '司机评价ID',
  `order_id` BIGINT UNSIGNED NOT NULL COMMENT '订单ID',
  `user_id` BIGINT UNSIGNED NOT NULL COMMENT '被评价乘客用户ID',
  `driver_id` BIGINT UNSIGNED NOT NULL COMMENT '评价司机ID',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='司机对乘客的评价';
