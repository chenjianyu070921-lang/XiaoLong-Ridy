...
CREATE TABLE IF NOT EXISTS `admin_complaint_work_order` (
  ...
  `source_type` VARCHAR(20) NOT NULL DEFAULT '' COMMENT '来源类型：user/driver/orderclient/system',
...
CREATE TABLE IF NOT EXISTS `risk_blacklist_hit_record` (
  ...
  `scene` VARCHAR(30) NOT NULL COMMENT '命中场景：login/orderclient/dispatch/pay/refund',
